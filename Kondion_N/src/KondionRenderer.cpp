...
namespace Kondion {
	...
	namespace Renderer {
		...
		void Setup() {
			...
			glBufferData(GL_ARRAY_BUFFER, sizeof(interlevedDataA), interlevedDataA, GL_STATIC_DRAW);
			...
			glBufferData(GL_ARRAY_BUFFER, sizeof(interlevedDataB), interlevedDataB, GL_STATIC_DRAW);
			glBindBuffer(GL_ARRAY_BUFFER, 0);
			...
			glBufferData(GL_ARRAY_BUFFER, sizeof(interlevedDataC), interlevedDataC, GL_STATIC_DRAW);
			glBindBuffer(GL_ARRAY_BUFFER, 0);
